class Piece {
  constructor(x, y, col, row, kind, match, sketch) {
    ...
    this.piece1 = this.sketch.loadImage('golden_gemstone-removebg-preview.png');
    this.piece2 = this.sketch.loadImage('blue_gemstone-removebg-preview.png');
    this.piece3 = this.sketch.loadImage('green_gemstone-removebg-preview.png');
    this.piece4 = this.sketch.loadImage('darkblue_gemstone-removebg-preview.png');
    this.piece5 = this.sketch.loadImage('grey_gemstone-removebg-preview.png');
    this.piece6 = this.sketch.loadImage('red_gemstone-removebg-preview.png');
  }
